...
class BookForm(forms.ModelForm):
    class Meta:
        model=models.Book
        fields=['name','isbn','author','category','ebook']
class IssuedBookForm(forms.Form):
    ...
    Mail_ID2=forms.ModelChoiceField(queryset=models.StudentExtra.objects.all(),empty_label="Name and mail",to_field_name='Mail_ID',label='Name and mail')
